...
ActiveRecord::Schema.define(version: 2019_07_31_161752) do
  ...
  create_table "diagnoses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "patient_diagnoses_id"
    t.integer "chronic_condition_id"
    t.index ["chronic_condition_id"], name: "index_diagnoses_on_chronic_condition_id"
    t.index ["patient_diagnoses_id"], name: "index_diagnoses_on_patient_diagnoses_id"
  end
